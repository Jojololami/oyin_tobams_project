...
const HeroCEO = () => {
  ...
  />
            ...
            {/* LIST (RIGHT on desktop) */}
           <div className="bg-[#eccfe4] rounded-2xl p-6 text-black/80 flex flex-col justify-between h-full">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                 ...
                 <li
  key={item}
  className="flex items-center gap-3 rounded-xl bg-white px-4 py-3.5 text-[14px] min-w-0 overflow-hidden"
>
                    <PurpleIcon />
